...
环境变量（优先级更高）：`CC_HUD_THEME`、`CC_HUD_COMPACT`、`CC_HUD_STATUS_FILE`。
...
<tr>
  ...
  <td>Go 订阅 — <code>5h:7% (1.7h) │ 7d:25% (2.8d) │ mo:98% (6.9d)</code></td>
</tr>
<tr>
...
<tr>
  ...
  <td>Coding Plan — <code>5h:0% (─) │ 7d:1% (2.3d) │ mo:3% (6.9d)</code></td>
</tr></table>
